...
const description =
  'A showcase of my work creating dynamic and visually engaging Tableau dashboards. These projects highlight my ability to transform complex data into actionable insights, focusing on usability, clarity, and impactful storytelling.';
const roles = [
  'Dashboard Development',
  'Data Visualization',
  'UX Design',
  'ETLs & Data Integration',
];
    ...
    <>
      <ProjectContainer>
        ...
        <ProjectHeader
          ...
          url="https://public.tableau.com/app/profile/keven.meehan/vizzes"
          roles={roles}
        />
